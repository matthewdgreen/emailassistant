...
def build_pass2_messages(
    ...
    system_content = (
        ...
        "       email_id, draft_outline (array of strings)\n"
        "   - other_notes: optional string\n"
        "5. For updated_senders:\n"
        "   - Only include senders whose importance or role changed today,\n"
        "     or that are clearly new and important.\n"
        "   - Do NOT include more than 20 updated_senders entries.\n"
        "   - Keep each 'notes' field short (no more than about 200 characters).\n"
        "6. For ALL string fields (including notes, reason_critical, "
        ...
        "(like draft_outline).\n"
        "7. DO NOT include comments or explanations in the JSON.\n"
    )
