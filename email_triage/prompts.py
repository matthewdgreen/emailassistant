...
def build_pass2_messages(
    ...
    system_content = (
        ...
        "   email_id, draft_outline (array of short, single-line strings)\n"
        " - other_notes: optional string\n"
        "5. DO NOT include comments or explanations in the JSON.\n"
        "6. Every string value must be a single-line string: do NOT include raw\n"
        "   newline characters inside a JSON string. If you need multiple bullets,\n"
        "   use an array of strings instead of line breaks.\n"
        "7. Avoid using double quotes inside strings; paraphrase instead or use\n"
